...
def get_sent_collections_to_publisher(publisher_id, curr_user_id):
    colls_id = get_collections_id_to_publisher(publisher_id, "Sent")
    colls = [get_collection(coll_id, curr_user_id)[0] for coll_id in colls_id]
    return colls


def get_sent_proses_to_publisher(publisher_id, curr_user_id):
    proses_id = get_proses_id_to_publisher(publisher_id, "Sent")
